...
function AllPlacesMap(){
  ...
  return <section className="all-map-wrap">
    ...
    <div className="map-stage all-map-stage"><img className="map-background" src={assetUrl("jeju-map-detail-v1.webp")} alt="" aria-hidden="true" width={1536} height={1024} loading="lazy" decoding="async"/>{mainland.map(place=>pin(place))}
